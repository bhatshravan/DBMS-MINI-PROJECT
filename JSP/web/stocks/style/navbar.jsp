<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand" href="#">Nifty 50 shravan</a>

			<!--img src="/WebApplication1/favicon.png" width="30" height="30" alt=""-->

		</div>
		<ul class="nav navbar-nav navbar-right">
			<li><a href="/WebApplication1/stocks/index.jsp">Home</a></li>
