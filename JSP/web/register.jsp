                    ...
                    <div id="login-column" class="col-md-6">
                        <div class="login-box col-md-12">
                                ...
                                <%                                                           
                                    ...
                                    ResultSet rs = st.executeQuery("select * from users where user_id='" + email + "';");
                                    if (rs.next()) {
                                        out.println(rs);
                                ...
                                <p class="text-info">User is already present<br></p>
                                    <%                                                        } else {
                                        //								String inser = "insert into users(`name`,`email`,`password`,`phone`,`bank`) values('"+name+"','"+email+"','"+pwd+"','"+phone+"','"+bank=");";
